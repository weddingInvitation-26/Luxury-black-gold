document.addEventListener('DOMContentLoaded', () => {
  ...
  (function createPetals() {
    ...
    for (let i = 0; i < petalCount; i++) {
      ...
      petal.style.background = ['#D4AF37', '#F0D68A', '#C9A96E', '#A8882E', '#2A2A2A'][Math.floor(Math.random() * 5)];
  ...
  const gradients = [
    'linear-gradient(135deg, #D4AF37, #F0D68A)',
    'linear-gradient(135deg, #0D0D0D, #2A2A2A)',
    'linear-gradient(135deg, #A8882E, #D4AF37)',
    'linear-gradient(135deg, #2A2A2A, #0D0D0D)',
    'linear-gradient(135deg, #C9A96E, #A8882E)',
